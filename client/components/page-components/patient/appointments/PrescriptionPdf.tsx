   ...
   <Document>
      <Page size="A4" style={styles.page}>
         <View style={styles.header}>
            <View>
               <Text style={styles.hospitalName}>VitalCare Connect</Text>
            </View>
         ...
         <View style={styles.footer}>
            <Text>
               This is a digital prescription generated by VitalCare Connect. Please contact your doctor at {doctor.phone}{" "}
