...
export default function OgImage() {
   ...
   useEffect(() => {
      ...
      img.onload = () => {
         ...
         ctx.fillText("VitalCare Connect", canvas.width / 2, 200);

         // Add subtitle
         ctx.font = "32px Arial";
         ctx.fillStyle = "#f0f0f0";
         ctx.fillText("Modern Telehealth & Virtual Care Platform", canvas.width / 2, 260);
   ...
   return (
      <Card className="p-6 max-w-3xl mx-auto">
         <h2 className="text-2xl font-bold mb-4">VitalCare Connect OG Image Preview</h2>
         <div className="mb-4">
